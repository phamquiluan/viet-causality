...
<!-- TABLE_START -->
_**122 researchers** across 16 countries. Confidence: 76 high, 40 medium, 6 low._

**By category:** Academic (83), Industry (9), PhD Students (30).

**By country (top 8):** Australia (39), United States (30), Vietnam (27), Japan (6), Germany (3), South Korea (3), Unknown (3), France (2).

**By sub-area (top 8):** `theoretical` (50), `causal-ml` (45), `causal-discovery` (35), `applied-health` (26), `counterfactual-explanation` (20), `causal-nlp` (9), `applied-bio` (9), `causal-rl` (8).
