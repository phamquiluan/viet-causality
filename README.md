...
<!-- TABLE_START -->
_**110 researchers** across 15 countries. Confidence: 64 high, 39 medium, 7 low._

**By category:** Academic (75), Industry (6), PhD Students (29).

**By country (top 8):** Australia (38), United States (27), Vietnam (22), Japan (6), Germany (3), South Korea (3), France (2), United Kingdom (2).

**By sub-area (top 8):** `causal-ml` (47), `theoretical` (38), `causal-discovery` (34), `applied-health` (27), `counterfactual-explanation` (19), `causal-rl` (8), `applied-bio` (8), `causal-nlp` (7).
...
| Pham, Vu |  | Rutgers, The State University of New Jersey | United States | `causal-ml` |  | medium |
