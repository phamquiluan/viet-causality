...
<!-- TABLE_START -->
_**101 researchers** across 15 countries. Confidence: 60 high, 35 medium, 6 low._

**By category:** Academic (66), Industry (6), PhD Students (29).

**By country (top 8):** Australia (35), United States (24), Vietnam (20), Japan (5), Germany (3), South Korea (3), France (2), United Kingdom (2).

**By sub-area (top 8):** `causal-ml` (39), `theoretical` (37), `causal-discovery` (34), `applied-health` (22), `counterfactual-explanation` (19), `causal-rl` (8), `applied-bio` (8), `causal-nlp` (7).
